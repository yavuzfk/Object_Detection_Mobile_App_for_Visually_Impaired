...
//  private BottomSheetBehavior<LinearLayout> sheetBehavior;
  ...
  /*
  * Uygulama keşfetme kapalı olarak açılacak
  * button_dinle_ara ile mikrofondan söylenen obje aranacak
  *
  * button_kesfet keşfet modunu açıp kapatmaya yarayacak.
  *       mTTs objesi text-to-speech engine olarak kullanılacak
  *       obje class isimeri assets/labelmap.txt file içinde bulunuyor, bunlar aynı sırada turkçeye
  *               çevrilecek
  *       mTTs objesi ile türkçe olarak okunacak.
  *
  *
  * */
  ...
  public void DinleButon() {
    ...
    RecognitionListener listener = new RecognitionListener() {
      ...
      public void onResults(Bundle results) {
        ...
        capitalCities.put("ayakkabı", "shoe");
        capitalCities.put("gözlük", "eye glasses");
        capitalCities.put("sırt çantası", "handbag");
        capitalCities.put("kravat", "tie");
        capitalCities.put("klavye", "keyboard");
        capitalCities.put("fare", "mouse");
        capitalCities.put("monitör", "tv");
        ...
        for(int i = 0; i < taninan_neseler.length;i++){  //**********************************************************************
          ...
          if(taninan_neseler[i].equals(aranan)){
            ...
            for (String xx : capitalCities.keySet()) { //////////////////////////////// TR to ENG
              if(xx.equals(aranan)){
                aranan = capitalCities.get(xx);
                break;
              }
            }
