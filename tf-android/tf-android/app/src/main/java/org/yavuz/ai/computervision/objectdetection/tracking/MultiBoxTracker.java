...
//      if(recognition.title.equals("couch")){
//        recognition.title = "yatak";
//      }else if(recognition.title.equals("keyboard")){
//        recognition.title = "klavye";
//      }else{
//        break;
//      }
      ...
      mapEngToTr.put("handbag", "sırt çantası");
            ...
            if(!CameraActivity.mTTs.isSpeaking() && (lastSay != recognition.title || diff/1000 >=2)){
              if (!CameraActivity.mTTs.isSpeaking()) {
                ...
                if (centerX < centerofScreen - 45) {
                  ...
                  CameraActivity.mTTs.speak(kesfetTemp + CameraActivity.solda, TextToSpeech.QUEUE_ADD, null, utterence);
                } else if (centerX > centerofScreen + 45) {
                  String utterence = this.hashCode() + "";
                  CameraActivity.mTTs.speak(kesfetTemp + CameraActivity.sagda, TextToSpeech.QUEUE_ADD, null, utterence);
                } else {
                  String utterence = this.hashCode() + "";
                  CameraActivity.mTTs.speak(kesfetTemp + CameraActivity.ortada, TextToSpeech.QUEUE_ADD, null, utterence);
                }
              }
      ...
      if (CameraActivity.BelirliArama && CameraActivity.mTTs != null) {
        ...
        if (gorulen.equals(CameraActivity.aranan)) {
          ...
          if (!CameraActivity.mTTs.isSpeaking()) {
            if (centerX < centerofScreen - 45) {
              String utterence = this.hashCode() + "";
              CameraActivity.mTTs.speak(gorulen + CameraActivity.solda, TextToSpeech.QUEUE_ADD, null, utterence);
            } else if (centerX > centerofScreen + 45) {
              String utterence = this.hashCode() + "";
              CameraActivity.mTTs.speak(gorulen + CameraActivity.sagda, TextToSpeech.QUEUE_ADD, null, utterence);
            } else {
              String utterence = this.hashCode() + "";
              CameraActivity.mTTs.speak(gorulen + CameraActivity.ortada, TextToSpeech.QUEUE_ADD, null, utterence);
            }
          }
        } else {
